	...
	return (
		<Flex px={["16px", "24px", "30px"]}>
			<Flex direction={["column", "column", "row"]} fontFamily="Inter, sans-serif" maxW="994px" margin="auto" mt="-140px" bg="#fff" borderRadius="12px" overflow="hidden" boxShadow="0px 20px 25px -5px rgba(0, 0, 0, 0.10), 0px 10px 10px -5px rgba(0, 0, 0, 0.04);">
				<Flex bg="rgba(101, 44, 211, 0.1)" direction="column" py="56px" px="48px" align="center" justify="space-between" gap='16px'>
					<Flex direction="column">
						<Text fontSize="24px" fontWeight="800">
							Premium PRO
						</Text>
						<Heading fontFamily="Inter, sans-serif" as="h3" fontSize={["48px", "48px", "60px"]} mt="16px">
							$329
						</Heading>
				...
				<Flex direction="column" p={["24px", "32px", "60px"]} fontSize="18px" >
