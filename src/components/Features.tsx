...
export function Feats() {
	return (
		<Flex maxW="898px" gap="20px" m="auto" pt="57px" pb="24px" direction={['column', 'column', 'row']}>
			<Flex gap="24px">
				<Box as="svg" width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<Flex gap="24px">
				<Box as="svg" width="48px" height="48px" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<Flex gap="24px">
				<svg width="48px" height="48px" viewBox="0 0 40 42" fill="none" xmlns="http://www.w3.org/2000/svg">
